...
namespace PhoneStore_New.Models
{
    ...
    public partial class PhoneStoreDBEntities : DbContext
    {
        public PhoneStoreDBEntities()
            : base("name=PhoneStoreDBEntities")
        {
        }
        ...
        public virtual DbSet<ProductNavbarLink> ProductNavbarLinks { get; set; }
